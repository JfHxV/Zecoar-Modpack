...
| 1.21 | 可用 | 可用 | 可用 | 1.1.1 | Java 21 |
| 1.21.1 | 不可用 | 不可用 | 不可用 | - | Java 21 |
| 1.21.3 | 不可用 | 可用 | 可用 | 1.0.1 | Java 21 |
| 1.21.4 | 不可用 | 可用 | 可用 | 1.0.1 | Java 21 |
| 1.21.6 | 不可用 | 不可用 | 可用 | 1.0.1 | Java 24 |
| 1.21.7 | 不可用 | 不可用 | 不可用 | - | Java 24 |
| 1.21.8 | 可用 | 不可用 | 可用 | 1.0.2 | Java 24 |
| 1.21.9 | 不可用 | 可用 | 不可用 | 0.1.0 | Java 24 |
