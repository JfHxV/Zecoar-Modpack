...
| 我的世界版本 | 早鸟版 | 测试版 | 正式版 | 最新版本 | Java 版本(推荐) |
| :-: | :-: | :-: | :-: | :-: | :-: |
| 1.20.6 | 不可用 | 不可用 | 可用 | 1.0.0 | Java 21 |
| 1.21 | 可用 | 可用 | 可用 | 1.1.2 | Java 21 |
| 1.21.1 | 不可用 | 不可用 | 可用 | 1.0.0 | Java 21 |
| 1.21.3 | 不可用 | 可用 | 可用 | 1.0.2 | Java 21 |
| 1.21.4 | 不可用 | 可用 | 可用 | 1.0.2 | Java 21 |
| 1.21.5 | 不可用 | 不可用 | 可用 | 1.0.1 | Java 24 |
| 1.21.6 | 不可用 | 不可用 | 可用 | 1.0.2 | Java 24 |
| 1.21.7 | 不可用 | 不可用 | 可用 | 1.0.1 | Java 24 |
| 1.21.8 | 可用 | 不可用 | 可用 | 1.0.3 | Java 24 |
| 1.21.9 | 不可用 | 可用 | 不可用 | 0.1.1 | Java 24 |
| 1.21.10 | 不可用 | 不可用 | 可用 | 1.0.0 | Java 24 |
| 1.21.11 | 不可用 | 可用 | 可用 | 1.0.0 | Java 24 |
| 26.1 | 不可用 | 不可用 | 不可用 | - | Java 25 |

<p>
  <img src="https://img.shields.io/badge/模组加载器-Fabric-dbd0b4?style=flat" alt="Fabric Mod Loader" />
  <img src="https://img.shields.io/badge/原版-增强-83d8ff?style=flat" alt="No Modfiy to the Gameplay">
</p>
...
若你想要切换材质包，你必须禁用 `彩虹像素RainbowPixel~☆...`，`彩虹像素☆村民交易UI删减包`，`南烛☆彩虹像素GUI`，`南烛☆**血量x**饱食度`，然后再启用你想用的材质包。
...
**版本名称解释**
![VNE](https://cdn.modrinth.com/data/cached_images/8bd4e6f3f2db83da81d0abcacf47992759c62052.png)
最后一位字母:                                 
R-正式版                                                    
B-测试版                                      
A-早期测试版                                                      
...
原版整合包太枯燥？我们有另一个整合包。[点击以了解详情](https://bbsmc.net/modpack/iwlow)
